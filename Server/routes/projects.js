...
router.get('/view/:projectID', projectCtrl.view);//view a singular project information, this includes all items attached to the project, as well as fixes and bug/inquiries
