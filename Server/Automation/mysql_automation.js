...
for(var i = 0; i< count; i++){
    if( (i%2) == 0 ){r = 0; /*console.log('r: '+r)*/}
    if( (i%2)  > 0 ){r = 1; /*console.log('r: '+r)*/}
...
/*for(var i = 0; i<fixes.length; i++){
    f.create({fixNumber: fixes[i], owner: 'joshuaada', title: 'random generic description'}, function(err, result){ 
        if(err){
